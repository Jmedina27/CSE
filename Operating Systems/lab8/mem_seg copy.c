...
QUESTIONS:
	...
	Question 5: As the variables are added to the stack, I notice that the addresses are getting smaller rather than getting larger.

	Question 6: Variables stored onto the stack do not have the same address because it can not share the same address on the stack.

	Question 7: I would expect my variables (or arguments) in the recursive function to be stored in the stack.
...
MEMORY DIAGRAM:
	...
	*/
	...
	//       |  TEXT            | x400200
	//       |                  |
	//       |  instructions in | x40140d= proc1
	//       |  machine code    | x4014f3 = proc2
	//       |                  |
	//       +------------------+ x401695 = etext
	//       |  DATA            | x40403c = g1
	//       |  - initialized   | x404040 = g3
	//       |    variables     | x404048 = ls1
	//       |                  | x40404c = ls3
	//       |                  |
	//       | ---------------  | x404050 = edata
	//       |  - uninitialized | x404084= g0
	//       |    variables     | x4040a0 = g2
	//       |                  | x404080 = g4
	//       |                  | x404064 = ls0
	//       |                  | x404068 = ls2
	//       | ---------------  | 
	//       |                  | x405810 = end
	//       |  - heap for      | x163fa80 pointed to by heap1
	//       |  dynamic         | x163faa0 pointed to by heap2
	//       |  allocation      |
	//       |                  |
	//       |                  |
	//       +------------------+ 
	...
	//                |
	//       +------------------+
	//       |  STACK           | x7ffefd68c2d8 = lc4, lc6
	//       |  - function      | x7ffefd68c2dc = lc3, lc5
	//       |    activation    | 
	//       |    records       |
	//       |  - local         | x7ffefd68c2f4 = lc2
	//       |    automatic     | x7ffefd68c2f8 = lc1
	//       |    variables     | x7ffefd68c2fc = lc0
	//       +------------------+
...
int main()
{
	...
	printf("\n\n---------- factorial --------------\n\n");
        printf("%14p (%15lu): Address of factorial function\n", 
               &factorial, &factorial);
	factorial(n);
...
int factorial(int n) 
{
	if (n >= 1)
	{
		printf("%14p (%15lu): Address of global n variable\n", 
		     &n, &n);
